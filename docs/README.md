# kaanha-claude-stack — Knowledge Base

Everything you need to install, use, and troubleshoot the stack.
...
**The 30-second version:** install two plugins → your `git push` becomes a locked door that only opens after your tests ran and an adversarial reviewer attacked your diff → say **"ship it"** and Claude does all of that for you. Plus one registry that runs every dev server on your machine without port fights.
